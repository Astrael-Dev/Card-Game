document.addEventListener("DOMContentLoaded", function () {
  const packs = [
    ...
    },
    {
      ...
      back: "chaosback.png",
      class: "chaos",
      cards: chaosPackCards,
    },
    {
      name: "Pack Tropical",
      price: 300,
      logo: "tropicallogo.png",
      back: "tropicalback.png",
      class: "tropical",
      cards: tropicalPackCards,
    },
  ];
  ...
  packs.forEach((pack) => {
    ...
    packItem.innerHTML = `
            ...
            <p>Prix: $${pack.price}</p>
        `;
    packItem.appendChild(buyButton);
    packsContainer.appendChild(packItem);
  });

  function buyPack(packName, packPrice, packBack, packCards) {
    ...
    for (let i = 0; i < 8; i++) {
      ...
      card.addEventListener("click", function () {
        if (!cardInner.classList.contains("flipped")) {
          ...
          if (cardsFlipped === 8) {
            // Check if all 8 cards are flipped
            setTimeout(() => {
